...
try {
    ...
    $sql = "SELECT nome_produto, qtd_produto FROM produtos";
    $stmt = $conn->query($sql);
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: dadosGastos,
                        backgroundColor: "rgba(244, 196, 48, 0.2)", // Fundo vermelho
                        borderColor: "rgba(244, 196, 48, 1)", // Borda vermelha
                        borderWidth: 1
                    }]
                },
                options: {
  ...
  <script>
      ...
      <li class="nav-item-bobo">
          ...
          <ul id="menu_item2" class="submenu collapse" data-bs-parent="#nav_accordion">
                ...
                <li class="nav-item-baba">
                    <a class="nav-link tabelaPrincipal"  onclick="redirecionarParaPaginaTabelas()" href="#"><i class="fas fa-search"></i> Gráfico Estoque </a>                  
                </li>
                <script>
      ...
      <li class="nav-item-baba">
                    <a class="nav-link tabelaPrincipal"  onclick="redirecionarParaPaginaTabelas()" href="#"><i class="fas fa-search"></i> Gráfico Entradas </a>                  
                </li>
                <script>
      ...
      <li class="nav-item-baba">
                    <a class="nav-link tabelaPrincipal"  onclick="redirecionarParaPaginaTabelas()" href="#"><i class="fas fa-search"></i> Gráfico Saídas (Fixo) </a>                  
                </li>
                <script>
      ...
      <li class="nav-item-baba">
                    <a class="nav-link tabelaPrincipal"  onclick="redirecionarParaPaginaTabelas()" href="#"><i class="fas fa-search"></i> Gráfico Saídas (Retornáveis) </a>                  
                </li>
                <script>
